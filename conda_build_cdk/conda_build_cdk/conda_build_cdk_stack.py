        ...
        pipelines.CodePipeline(
            ...
            synth=pipelines.CodeBuildStep(
                ...
                commands=[
                    ...
                    "conda install --file environment.lock.yml",
                    "ln -sf /opt/conda/x86_64-conda-linux-gnu/sysroot/usr/lib64 /usr/lib64",
                    "ln -sf /opt/conda/x86_64-conda-linux-gnu/sysroot/lib64/libpthread.so.0 /lib64/libpthread.so.0",
                    "ln -sf /opt/conda/x86_64-conda-linux-gnu/sysroot/lib64/libc.so.6 /lib64/libc.so.6",
